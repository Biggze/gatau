export function RenderContent(){
    ...
    <div class="profile-detail">
      ...
      <div class="my-social-media-accounts">
        ...
        <a
          class="social-media"
          target="_blank"
          href="${homeDetails.LinkedInLink}">
          <img src="images and icons/icons/linkedin.png" alt="Linkedin icon" />
        </a>
  ...
  const homeSection = document.querySelector('#home-section').innerHTML = homeHTML;
   ...
   const aboutDetails = {
    myPhoto: 'me.jpg',
    aboutMeFirstPrgrph: `Hi! I'm Nofal, a TikToker and programmer who loves sharing creative and inspiring work. I create content featuring my cute programming outputs, turning complex code into visually appealing and fun projects that resonate with my audience.`,
  ...
  const aboutSection = document.querySelector('#about-section').innerHTML = aboutHTML;
    ...
    const skills = [
      ...
      { iconName: "music.png", skillName: "Music" },
      { iconName: "react.png", skillName: "react"},
